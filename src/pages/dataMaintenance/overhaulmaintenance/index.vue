<template>
  <div class="supplement">
    <div class="search">
      ...
      <div class="option-wrapper">
        <input type="file" @change="readFile" style="width:0;display: none;" ref="upload" />
...
<script>
import { overhaulmaintenance } from '@/services/dataMaintenance'
